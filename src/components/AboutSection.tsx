...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="relative py-16 sm:py-20 px-4 sm:px-6 bg-background text-foreground transition-colors duration-500 overflow-hidden"
    >
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-10 sm:mb-12">
          {snapshots.map((snap) => (
            <div
              key={snap.title}
              className="relative p-5 sm:p-6 bg-card text-card-foreground rounded-2xl sm:rounded-3xl 
            ...
            >
              {/* Glow Overlay */}
              <div className="absolute inset-0 rounded-2xl sm:rounded-3xl bg-gradient-to-tr from-blue-500 via-purple-500 to-pink-500 opacity-10 blur-xl transition-opacity duration-500 group-hover:opacity-20"></div>
