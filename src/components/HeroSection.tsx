...
const HeroSection = () => {
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-center lg:text-left fade-in">
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold font-playfair mb-6 whitespace-nowrap">
            ...
            <div className="mb-8">
              <div className="typewriter-container text-xl sm:text-2xl font-semibold">
  ...
  <Button
    className="glow-hover bg-gradient-primary text-primary-foreground font-semibold px-8 py-6 text-lg rounded-xl"
    size="lg"
  >
    ...
    Download Resume
          ...
          <div className="flex justify-center lg:justify-end fade-in fade-in-delay-2">
            <div className="profile-glow">
              <div className="w-80 h-80 sm:w-96 sm:h-96 lg:w-[400px] lg:h-[400px] rounded-full overflow-hidden bg-gradient-card">
                <img
                  src={profileImage}
